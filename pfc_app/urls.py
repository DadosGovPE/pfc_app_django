...
urlpatterns = [
    ...
    path("api/password/change/", views.api_password_change, name="api_password_change"),
    ...
    path(
        "curso_detail/<int:pk>/<str:lotado>",
    ...
    path(
        "generate_all_pdfs/<int:curso_id>/",
        views.generate_all_pdfs,
        name="generate_all_pdfs",
    ),
    path(
        "generate_all_pdfs/<int:curso_id>/<int:unico>/",
        views.generate_all_pdfs,
        name="generate_all_pdfs",
    ),
    path(
    ...
    path(
        "generate_reconhecimento/<int:validacao_id>/",
        views.generate_all_reconhecimento,
        name="generate_reconhecimento",
    ),
    path("gerar_ata/<int:curso_id>/", views.gerar_ata, name="gerar_ata"),
    path(
        "gerar_relatorio/<int:curso_id>/", views.gerar_relatorio, name="gerar_relatorio"
    ),
    path("relatorio/", views.relatorio, name="relatorio"),
    path("explorer/", include("explorer.urls")),
    path("usuarios_sem_ch/", views.usuarios_sem_ch, name="usuarios_sem_ch"),
    path(
        "gerar_curadoria/<int:ano>/<int:mes>",
        views.gerar_curadoria,
        name="gerar_curadoria",
    ),
    path("curadoria/", views.curadoria, name="curadoria"),
    path("curadoria_show/", views.curadoria_html_show, name="curadoria_show"),
    path(
        "curadoria_html/<int:ano>/<int:mes>/",
        views.curadoria_html,
        name="curadoria_html",
    ),
    path("estatisticas_lnt/", views.estatistica_lnt, name="estatisticas_lnt"),
    path(
        "pesquisa_priorizacao/",
        views.listar_cursos_priorizados,
        name="listar_cursos_priorizados",
    ),
    ...
    path(
        "gerar-pdf-bda/<int:ano>/<int:mes>",
        views.generate_bda_pdf,
        name="gerar_pdf_bda",
    ),
    path("pdf_bda/", views.estatistica_bda, name="estatistica_bda"),
    path(
        "planocurso_duplicar/", views.duplicar_plano_curso, name="duplicar_plano_curso"
    ),
    path("change-lotacao/", views.select_lotacao_view, name="change_lotacao"),
    path(
        "lotacao-especifica/",
        views.get_lotacao_especifica,
        name="get_lotacao_especifica",
    ),
    path(
        "nova-lotacao-especifica/",
        views.get_nova_lotacao_especifica,
        name="get_nova_lotacao_especifica",
    ),
    path("listar-usuarios/", views.listar_usuarios, name="listar_usuarios"),
    path(
        "atualizar-lotacao-usuario/",
        views.atualizar_lotacao_usuario,
        name="atualizar_lotacao_usuario",
    ),
    ...
    path(
        "api/cursos-disponiveis/", views.cursos_disponiveis, name="cursos_disponiveis"
    ),
    ...
    path(
        "api/emendas/resumo/<str:id_parlamentar>/",
        views.resumo_emendas,
        name="resumo_emendas",
    ),
    # path('api/emendas/resumo/municipios/<int:cd_mun>/', views.resumo_emendas_municipios, name='resumo_emendas_municipios'),
    path(
        "api/resumo-emendas-municipio/<int:cd_mun>/",
        views.resumo_emendas_municipio,
        name="resumo_emendas_municipio",
    ),
    path(
        "api/emendas/top-deputados/",
        views.top_deputados_emendas,
        name="top_deputados_emendas",
    ),
    path(
        "api/emendas/top-municipios/",
        views.top_municipios_emendas,
        name="top_municipios_emendas",
    ),
