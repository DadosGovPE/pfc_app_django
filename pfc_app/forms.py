...
from .models import (
    ...
    User,
    PriorizacaoResposta,
)  # Certifique-se de importar o modelo Avaliacao
...
class SubtemaForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            "tema",
            "cor",
        ]  # Inclui apenas o campo que você deseja modificar
        widgets = {
    ...
    class Meta:
        ...
        widgets = {
            "comentario": forms.Textarea(
                attrs={
                    "rows": 4,
                    "placeholder": "Digite aqui. Caso haja mais de um curso, separe por ponto e vírgula.",
                }
            )
        }
        labels = {"comentario": "Sentiu falta de algum curso? Então diz pra gente:"}
